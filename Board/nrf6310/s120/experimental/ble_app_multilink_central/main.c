...
static void ble_stack_init(void)
{
    ...
    SOFTDEVICE_HANDLER_INIT(NRF_CLOCK_LFCLKSRC_XTAL_20_PPM, false);//系统事件调度功能关闭，选择时钟源
...
static void connection_manager_init(void)
{
    ...
    param.ntf_cb = connection_manager_event_handler;//连接事件管理回调函数
