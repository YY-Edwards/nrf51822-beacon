...
/** @brief Beacon data for advertisement report data. */
...
/**
 * @brief ibeacon distancing calculate function.
 *
 * @details The distance estimate provided by somewhere is based on 
 *          the ratio of the iBeacon signal strength (rssi) over the calibrated transmitter power (txPower). 
 ...
 *
 * @param[in]  txPower   The txPower is the known measured signal strength in rssi at 1 meter away. 
 *             rssi      Received Signal Strength Indication right now. 
 *  
 * @return accuracy.
 * @note: Note that the term "accuracy" here is iOS speak for distance in meters. 
